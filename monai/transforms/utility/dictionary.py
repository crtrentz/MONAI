...
class DataStatsd(MapTransform):
    ...
    def __init__(
        self,
        keys,
        prefix: Union[str, List[str]] = "Data",
        data_shape: Union[bool, List[bool]] = True,
        intensity_range: Union[bool, List[bool]] = True,
        data_value: Union[bool, List[bool]] = False,
        additional_info: Optional[Union[Callable, List[Callable]]] = None,
...
class SimulateDelayd(MapTransform):
    ...
    def __init__(self, keys, delay_time: Union[float, List[float]] = 0.0):
        """
        Args:
            keys (hashable items): keys of the corresponding items to be transformed.
                See also: :py:class:`monai.transforms.compose.MapTransform`
