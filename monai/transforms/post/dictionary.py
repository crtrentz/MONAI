...
class SplitChanneld(MapTransform):
    ...
    def __init__(
        self,
        keys,
        output_postfixes: Union[list, tuple],
        to_onehot: Union[bool, List[bool]] = False,
        num_classes: Optional[Union[int, List[int]]] = None,
    ):
        """
        Args:
...
class Activationsd(MapTransform):
    ...
    def __init__(
        ...
        sigmoid: Union[bool, Tuple[bool], List[bool]] = False,
        softmax: Union[bool, Tuple[bool], List[bool]] = False,
        other: Optional[Union[Callable, Tuple[Callable], List[Callable]]] = None,
    ):
        """
        Args:
            ...
            sigmoid: whether to execute sigmoid function on model
                output before transform.
            softmax: whether to execute softmax function on model
                output before transform.
