...
from monai.utils.enums import PadMode

TEST_CASE_1 = [
    {"spatial_size": [15, 8, 8], "method": "symmetric", "mode": PadMode.CONSTANT},
    np.zeros((3, 8, 8, 4)),
    np.zeros((3, 15, 8, 8)),
]

TEST_CASE_2 = [
    {"spatial_size": [15, 8, 8], "method": "end", "mode": PadMode.CONSTANT},
    np.zeros((3, 8, 8, 4)),
    np.zeros((3, 15, 8, 8)),
]


class TestSpatialPadEnum(unittest.TestCase):
